...
public class VistaRequerimientosReto4 {
        ...
        try {
            ...
            for (Requerimiento1 proyectoRankeado : rankingProyectosCompras) {
                System.out.printf("%d %s %d %s %n",
                        proyectoRankeado.getIdProyecto(),proyectoRankeado.getClasificacion(),
                        Math.round( proyectoRankeado.getGastoCompras()), proyectoRankeado.getSerial());
            }
    ...
    public static void requerimiento2() {
        ...
        System.out.println("-----Ranking Bancos Con Mayor Área (Área Proyectos)-------");
    ...
    public static void requerimiento3() {
        ...
        try {
            ...
            for (Requerimiento3 material : rankingMaterialesImportados) {
                System.out.printf("%s %s %d %n",material.getNombreMaterial(),material.getImportado(),material.getNoCompras());
            }
